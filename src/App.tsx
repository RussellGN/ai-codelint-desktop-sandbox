...
export default function App() {
   const { error, loading, fileInputRef, lintResult, textAreaRef, openFile, onFileChange, onLintContents, closeDiagnostics } = useApp();
   ...
   return (
      <div className="h-screen flex flex-col p-5">
         ...
         <div className="grow grid grid-cols-5">
            <LintResult loading={loading} error={error} lintResult={lintResult} closeDiagnostics={closeDiagnostics} />
